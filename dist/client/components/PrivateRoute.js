...
var _excluded = ["element"]; // src/client/components/PrivateRoute.js
...
var PrivateRoute = function PrivateRoute(_ref) {
  ...
  var _useState = (0, _react.useState)(null),
    ...
    isUserAuthenticated = _useState2[0],
    setIsUserAuthenticated = _useState2[1];
  var location = (0, _reactRouterDom.useLocation)();
  var _getConfig = (0, _config.getConfig)(),
    REACT_APP_API_BASE_URL = _getConfig.REACT_APP_API_BASE_URL;
      ...
      var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0, _auth.isAuthenticated)(REACT_APP_API_BASE_URL);
            case 2:
              authStatus = _context.sent;
              // Pass REACT_APP_API_BASE_URL if needed
  ...
  return /*#__PURE__*/_react["default"].createElement(Element, rest);
};
